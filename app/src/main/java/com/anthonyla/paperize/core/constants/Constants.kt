...
object Constants {
    // Database
    const val DATABASE_NAME = "magen_wallpaper_database"
    const val DATABASE_VERSION = 4  // v4: Removed unused cropOffsetX/Y/Scale columns from wallpapers table

    // DataStore
    const val PREFERENCES_NAME = "magen_wallpaper_preferences"

    // Notifications
    const val NOTIFICATION_CHANNEL_ID = "magen_wallpaper_channel"
